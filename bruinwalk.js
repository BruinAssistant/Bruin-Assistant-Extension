...
function findClassInst(){
    ...
    for (let i = 0; i < uclaClasses.length; i++){
        ...
        let instName = courseTable[7].innerText

        let courseMajor = uclaClasses[i].getElementsByTagName('p')[0].innerText.split(": ")[1];
        let courseNum = uclaClasses[i].getElementsByTagName('p')[1].innerText.split(" - ")[0];
        ...
        let allInstName = instName.split(/\n/);
